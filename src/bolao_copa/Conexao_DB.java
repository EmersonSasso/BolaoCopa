...
public class Conexao_DB extends javax.swing.JDialog {
    ...
    public Conexao_DB(java.awt.Frame parent, boolean modal, Metodos_Comum met) {
        super(parent, modal);
        initComponents();
        this.met = met;
    ...
    private void buttonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOKActionPerformed
        if (!("".equals(fieldPort.getText())) && (!("".equals(fieldHost.getText()))) && (!("".equals(fieldLogin.getText()))
                && (!("".equals(met.passToString(fieldPassword.getPassword())))) && (!("".equals(fieldAlias.getText()))))) {
            ...
            try {
                if (met.isConnected(fieldLogin.getText().toUpperCase(), fieldPassword.getPassword())) {
                    fieldLogin.setText("");
                ...
                switch (e.getModifiersEx()) {
                    case (InputEvent.CTRL_DOWN_MASK):
                        ...
                        if (buttonOK.isEnabled()) {
                            met.SaveFile(fieldHost.getText(), fieldAlias.getText(), fieldPort.getText());
                        }
                        break;
